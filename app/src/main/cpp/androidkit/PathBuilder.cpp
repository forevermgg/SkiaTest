...
static jlong PathBuilder_Create(JNIEnv* env, jclass clazz) {
  return reinterpret_cast<jlong>(new SkPathBuilder());
}

static void PathBuilder_Release(JNIEnv* env, jclass clazz,
                                jlong native_pathBuilder) {
  delete reinterpret_cast<SkPathBuilder*>(native_pathBuilder);
}

static void PathBuilder_MoveTo(JNIEnv* env, jclass clazz,
                               jlong native_pathBuilder, jfloat x, jfloat y) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
    pathBuilder->moveTo(x, y);
  }
}

static void PathBuilder_LineTo(JNIEnv* env, jclass clazz,
                               jlong native_pathBuilder, jfloat x, jfloat y) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
...
static void PathBuilder_QuadTo(JNIEnv* env, jclass clazz,
                               jlong native_pathBuilder, jfloat x1, jfloat y1,
                               jfloat x2, jfloat y2) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
...
static void PathBuilder_ConicTo(JNIEnv* env, jclass clazz,
                                jlong native_pathBuilder, jfloat x1, jfloat y1,
                                jfloat x2, jfloat y2, jfloat w) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
...
static void PathBuilder_CubicTo(JNIEnv* env, jclass clazz,
                                jlong native_pathBuilder, jfloat x1, jfloat y1,
...
static void PathBuilder_Close(JNIEnv* env, jclass clazz,
                              jlong native_pathBuilder) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
    pathBuilder->close();
...
static void PathBuilder_SetFillType(JNIEnv* env, jclass clazz,
                                    jlong native_pathBuilder, jint fill) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
    switch (fill) {
      case 0:
...
static jlong PathBuilder_MakePath(JNIEnv* env, jclass clazz,
                                  jlong native_pathBuilder) {
  if (auto* pathBuilder =
          reinterpret_cast<SkPathBuilder*>(native_pathBuilder)) {
...
int register_androidkit_PathBuilder(JNIEnv* env) {
  static const JNINativeMethod methods[] = {
      ...
      {"nSetFillType", "(JI)V",
       reinterpret_cast<void*>(PathBuilder_SetFillType)},
